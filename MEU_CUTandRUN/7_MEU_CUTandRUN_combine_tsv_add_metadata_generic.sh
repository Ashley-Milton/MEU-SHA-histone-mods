...
if [ "$Sex" = "Female" ]; then
    export Sex_Histone="F_${Tissue}_${Histone}"
    export Sex_HistoneDir=$(ls -d F_${Tissue}_${Histone}_*_treat_pileup | grep -E "F_${Tissue}_${Histone}_.*_treat_pileup")
elif [ "$Sex" = "Male" ]; then
    export Sex_Histone="M_${Tissue}_${Histone}"
    export Sex_HistoneDir=$(ls -d M_${Tissue}_${Histone}_*_treat_pileup | grep -E "M_${Tissue}_${Histone}_.*_treat_pileup")
fi
